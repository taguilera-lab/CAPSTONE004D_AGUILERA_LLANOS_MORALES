...
urlpatterns = [
    ...
    path('ordenes-trabajo/<int:work_order_id>/pausa-personal/', views.orden_trabajo_pausa_personal, name='orden_trabajo_pausa_personal'),
    path('ordenes-trabajo/<int:work_order_id>/pausa-personal/terminar/', views.orden_trabajo_pausa_personal_end, name='orden_trabajo_pausa_personal_end'),
    path('ordenes-trabajo/<int:work_order_id>/iniciar-trabajos/', views.orden_trabajo_start_work, name='orden_trabajo_start_work'),
