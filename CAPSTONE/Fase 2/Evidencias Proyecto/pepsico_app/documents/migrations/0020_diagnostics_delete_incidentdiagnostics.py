# Generated by Django 4.2.25 on 2025-10-26 01:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('documents', '0019_remove_incident_affects_operation_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(blank=True, db_column='assigned_to_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_diagnostics', to='documents.flotauser')),
                ...
                ('diagnostics_created_by', models.ForeignKey(blank=True, db_column='diagnostics_created_by_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_diagnostics', to='documents.flotauser')),
                ('diagnostics_updated_by', models.ForeignKey(blank=True, db_column='diagnostics_updated_by_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_diagnostics', to='documents.flotauser')),
                ('incident', models.OneToOneField(blank=True, db_column='incident_id', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='diagnostics', to='documents.incident')),
                ('related_ingreso', models.ForeignKey(blank=True, db_column='related_ingreso_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='diagnostics', to='documents.ingreso')),
                ('related_schedule', models.ForeignKey(blank=True, db_column='related_schedule_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='diagnostics', to='documents.maintenanceschedule')),
                ('related_work_order', models.ForeignKey(blank=True, db_column='related_work_order_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='diagnostics', to='documents.workorder')),
                ('route', models.ForeignKey(blank=True, db_column='route_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='diagnostics', to='documents.route')),
            ],
            options={
