...
function generarTiemposHorasHombre() {
    ...
    // Construir URL con parámetro de período
    const url = `/document_upload/reports/generate/tiempos_horas_hombre/?periodo=${periodo}`;
...
function generarRepuestosUtilizados() {
    ...
    // Construir URL con parámetro de período
    const url = `/document_upload/reports/generate/repuestos_utilizados/?periodo=${periodo}`;
...
function generarVehiculosIngresadosSalidos() {
    ...
    // Construir URL con parámetro de período
    const url = `/document_upload/reports/generate/vehiculos_ingresados_salidos/?periodo=${periodo}`;
